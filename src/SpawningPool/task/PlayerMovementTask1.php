...
class PlayerMovementTask1 extends AsyncTask {
	...
	public function __construct(Player $player, $dx, $dy, $dz, $callbackIndex) {
	...
	public function onCompletion(Server $server) {
		...
		if ($plugin instanceof Main and $bb instanceof AxisAlignedBB) {
			$plugin->getCallback ()->moveplayer->playerMoveCallback1 ( $this->name, $bb, $this->minX, $this->minY, $this->minZ, $this->maxX, $this->maxY, $this->maxZ, $this->dx, $this->dy, $this->dz, $this->callbackIndex );
		}
	}
}
